        ...
        <footer style={{ padding: '20px'  }}>
            <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap' }}>
                        ...
                        +32 2 649 75 35
                                ...
                                {/* Column 2: Links */}
                                <div style={{ flex: '1', minWidth: '200px', textAlign: 'left', marginBottom: '20px' }}>
                                    <Link href="/menu" style={{ display: 'block', margin: '5px 0', textDecoration: 'underline', fontWeight: 'normal', transition: 'font-weight 0.2s' }} >Menu</Link>
                                    <Link href="/entreprise" style={{ display: 'block', margin: '5px 0', textDecoration: 'underline', fontWeight: 'normal', transition: 'font-weight 0.2s' }} >Entreprise</Link>
                                </div>
            ...
            <p style={{ textAlign: 'center', margin: '10px 0', fontSize: '14px' }}>
                © {currentYear} Oggi Pasta. All rights reserved.
            </p>
        </footer>
    );
};
